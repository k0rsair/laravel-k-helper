...
const PHP_HELPER_CONTEXTS: Array<{ kind: LaravelIndexKind; regex: RegExp }> = [
  ...
  { kind: "artisan-command", regex: /\bArtisan::(?:call|queue)\(\s*['"]([^'"]*)$/ },
  { kind: "artisan-command", regex: /\bartisan\(\s*['"]([^'"]*)$/ },
  { kind: "artisan-command", regex: /(?:\$this|\$[A-Za-z_][A-Za-z0-9_]*)->(?:command|call|callSilent|callQueued)\(\s*['"]([^'"]*)$/ },
